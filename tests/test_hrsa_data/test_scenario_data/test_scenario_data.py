...
class TestScenarioData(unittest.TestCase):
    ...
    def test_scenario_information(self):
        ...
        with open(self.file_path_to_test, 'w', encoding=afsc.DEFAULT_FILE_ENCODING) as f:
            json.dump(asdict(ScenarioInformation()), f, indent=4)

        with open(self.file_path_to_test, 'r', encoding=afsc.DEFAULT_FILE_ENCODING) as f:
