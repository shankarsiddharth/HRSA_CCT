...
class RoomFeedbackFolderData:
    ...
    def create_new_room_feedback_folder(self) -> FileSystemResultData:
        ...
        new_room_feedback_folder_path = pathlib.Path(self.folder_root_path)
        ...
        self.feedback_ink_file_path = os.path.join(self.folder_root_path, __hdfsc__.FEEDBACK_INK_FILE_NAME)
        ...
        # Feedback Ink JSON File Path
        self.feedback_ink_json_file_path = os.path.join(self.folder_root_path, __hdfsc__.FEEDBACK_INK_JSON_FILE_NAME)
