...
class FeedbackRoomFolderData:
    # Feedback Room Folder Name
    room_name: str = field(default=__hdfsc__.FEEDBACK_ROOM_NAME)
        ...
        for dir_item in dir_list:
            ...
            if os.path.isdir(dir_item_path):
                if dir_item == __hdfsc__.FEEDBACK_TYPE_BREAK_ROOM_NAME:
                    self.break_room_feedback_folder_data.folder_root_path = dir_item_path
                    self.break_room_feedback_folder_data.room_name = __hdfsc__.FEEDBACK_TYPE_BREAK_ROOM_NAME
                ...
                if dir_item == __hdfsc__.FEEDBACK_TYPE_PATIENT_ROOM_NAME:
                    self.patient_room_feedback_folder_data.folder_root_path = dir_item_path
                    self.patient_room_feedback_folder_data.room_name = __hdfsc__.FEEDBACK_TYPE_PATIENT_ROOM_NAME
    ...
    def create_new_feedback_room_folder(self) -> FileSystemResultData:
        feedback_room_folder_root_path = pathlib.Path(self.folder_root_path)
        ...
        self.break_room_feedback_folder_data.room_name = __hdfsc__.FEEDBACK_TYPE_BREAK_ROOM_NAME
        self.break_room_feedback_folder_data.folder_root_path = os.path.join(self.folder_root_path, __hdfsc__.FEEDBACK_TYPE_BREAK_ROOM_NAME)
        ...
        self.patient_room_feedback_folder_data.room_name = __hdfsc__.FEEDBACK_TYPE_PATIENT_ROOM_NAME
        self.patient_room_feedback_folder_data.folder_root_path = os.path.join(self.folder_root_path, __hdfsc__.FEEDBACK_TYPE_PATIENT_ROOM_NAME)
