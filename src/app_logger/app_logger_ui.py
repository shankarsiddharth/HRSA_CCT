...
class AppUILogger:
    ...
    def __init__(self, parent, is_open: bool = True, log_level: int = logging.NOTSET):
        ...
        if parent:
            ...
            self.window_id = dpg.add_window(label="HRSA CCT Logger", no_title_bar=False, no_close=True)
    ...
    def __on_show_all_logs(self):
        ...
        if show_all_logs:
            ...
            dpg.set_value(self.filter_id, '-[TRACE], -[DEBUG], [INFO], [SUCCESS], [WARNING], [ERROR], [CRITICAL]')
